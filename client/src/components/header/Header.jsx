...
import { faBed, faCar, faPerson, faPlaceOfWorship, faPlane, faTaxi } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className='header'>
     <div className={type === "list" ? "headerContainer listModel" : "headerContainer"} >
      <div className="headerContainer">  
          ...
          <p className="headerDescription">Get reward for your travels - unlock instant savings of 10% with a free Casatel Account</p>
          ...
          <div className="headerSearchItem">
            ...
            <span onClick={()=>setOpenDate(!openDate)} className='headerSearchText'>{`${format(
              dates[0].startDate,
              "MM/dd/yyyy")} to ${format(dates[0].endDate,"MM/dd/yyyy")}`}</span>
            {openDate && <DateRange
